...
let AppComponent = class AppComponent {
    ...
    ngAfterViewInit() {
        let display_list = document.getElementsByClassName('display_list');
...
/* harmony import */ var _components_backstage2_backstage2_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/backstage2/backstage2.component */ "./src/app/components/backstage2/backstage2.component.ts");
/* harmony import */ var _components_backstage2_article_article_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/backstage2/article/article.component */ "./src/app/components/backstage2/article/article.component.ts");
...
/* harmony import */ var _components_backstage2_add_edit_add_edit_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/backstage2/add-edit/add-edit.component */ "./src/app/components/backstage2/add-edit/add-edit.component.ts");
/* harmony import */ var ngx_quill__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ngx-quill */ "./node_modules/_ngx-quill@7.3.7@ngx-quill/fesm2015/ngx-quill.js");
/* harmony import */ var _components_popup_popup_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/popup/popup.component */ "./src/app/components/popup/popup.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_backstage2_backstage2_component__WEBPACK_IMPORTED_MODULE_8__["Backstage2Component"],
            _components_backstage2_article_article_component__WEBPACK_IMPORTED_MODULE_9__["ArticleComponent"],
            _components_backstage2_add_edit_add_edit_component__WEBPACK_IMPORTED_MODULE_11__["AddEditComponent"],
            _components_popup_popup_component__WEBPACK_IMPORTED_MODULE_13__["PopupComponent"],
        ],
        imports: [
...
let AddEditComponent = class AddEditComponent {
    ...
    tu(key) {
        ...
        reader.onload = function () {
            let s = document.getElementById('imj'); /*渲染图片*/
            s.src = this.result;
            console.log(s.src);
        ...
        let o = key.target.files[0].size / 1048576;
        if (o < 1024) {
    ...
    sc() {
        ...
        // })
        this.https.axiosGet(this.sctp, this.config).then((da) => {
    ...
    online_immediately() {
        ...
        this.post(api, httpOptions, data).subscribe((response) => {
            console.log(response);
            if (response.code == 0) {
    ...
    cancel() {
        ...
        let p = '/a/article/search?page=1&size=10';
        this.https.getqingqiu(p);
    }
    // 数据序列化
    post(url, httpOptions, data) {
...
let ArticleComponent = class ArticleComponent {
    constructor(aa, service, router, http) {
        this.aa = aa;
    ...
    ngOnInit() {
        ...
        if (lastnamepage === null) {
            ...
            // 接收返回的数据
            this.service.getqingqiu(this.p).then((response) => {
    ...
    ngAfterViewInit() {
        ...
        // }
        //  输入框每页展示的条数
        let myxs = document.getElementById('myxs');
        ...
        // 展示的页数
        let djy = document.getElementById('djy');
    ...
    popup(event) {
        ...
        if (event == 0) {
            ...
            this.service.putqingqiu(this.p, a).then((response) => {
                console.log(response.message);
                sessionStorage.setItem("message", response.message);
                if (response.code == 0) {
                    //  window.location.reload();
            ...
            this.http.delete(this.p).subscribe((response) => {
                console.log(response);
                if (response.code == 0) {
...
let Backstage2Component = class Backstage2Component {
    ...
    ngOnInit() {
        ...
        this.url.params.subscribe((data) => {
            console.log(data);
        });
        let Welcome = document.getElementsByClassName('Welcome')[0];
        //  this.router.events.subscribe((event)=>{
    ...
    ngAfterViewInit() {
        let display_list = document.getElementsByClassName('display_list');
        let hidden_list_box = document.getElementsByClassName('hidden_list_box');
        let lcon = document.getElementsByClassName('lcon');
        ...
        let Explicit = document.getElementsByClassName('main_left')[0];
...
Backstage2Component.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
...
let ServiceService = class ServiceService {
    ...
    putqingqiu(api, a) {
        return new Promise((resolve, reject) => {
            ...
            this.http.put(api, a, httpOptions).subscribe((response) => {
                console.log(response);
                resolve(response);
            });
        });
